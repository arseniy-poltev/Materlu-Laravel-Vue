...
@section('content')
        ...
        <div class="apearence" id="apBox">
            ...
            <form action="{{ u('customize/name') }}" method="post" class="apearence_form" id="customize_name_form">
                ...
                <div class="gender_choise">
                    ...
                    <img src="{{ asset('images/indexPage/settings-girl.svg') }}" width="70" height="107.38" alt="girl" class="char_Settings_girl">
                    ...
                    <img src="{{ asset('images/indexPage/martin.svg') }}" alt="boy" width="62" height="107.38" class="char_Settings_boy">
                </div>
                ...
                <div class="char_settings">
                    ...
                    <div class="font_style">
                        ...
                        <input type="radio" id="r3" checked required name="font_style" value="standard" {{ $data->font_style == 'standard' ? 'checked' : '' }} class="gender_check">
 ...
 <div class="arrow_box">
            ...
            <a href="{{ u('cuentos') }}" class="back_link">
                <img src="{{ asset('images/characterPage/right-arrow.png') }}" alt="arrow image" class="story_link-arrow">
