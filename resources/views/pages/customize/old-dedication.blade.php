...
@section('content')
    ...
    <main class="new_bg">
        ...
        <div class="apearence">
            <form action="{{ u('customize/dedication') }}" enctype="multipart/form-data" method="post" class="apearence_form2" id="customize_dedication_form">
                @csrf
                ...
                <textarea class="dedication_input" maxlength="4000" name="dedication" placeholder="{{ t('Dear Anna, This is a fairy tale for a special girl like you. We hope you have fantastic adventures surrounded by those who love you most.') }}">{{ $data->dedication }}</textarea>
            ...
            <div class="arrow_box">
                <div class="prev_arrow"><img src="{{ asset('images/characterPage/back-arrow.png') }}">
            ...
            <div class="advice_box"><p class="advice_item">{{ t('Check your dedication carefully to make sure there are no mistakes.') }}</p>
                <p class="advice_item">{{ t('Once your order is printed, we cannot change anything.') }}</p>
                <p class="advice_item">{{ t('We can´t accept any responsibility for any mistakes in the dedication.') }}</p></div>
        </div>
    </main>
